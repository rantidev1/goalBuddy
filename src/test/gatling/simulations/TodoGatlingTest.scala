...
class TodoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Todo entity")
        ...
        .repeat(2) {
            ...
            .post("/api/todos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "priority":"0"}""")).asJSON
            .check(status.is(201))
